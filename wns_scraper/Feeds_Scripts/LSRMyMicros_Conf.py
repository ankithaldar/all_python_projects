'''This is config file used by Oracle LSRevnueMyMicros Daily process.
...
ApplicationPath='//ms12495/WNS Reporting/Ranveer/LSRevenueMyMicros/'
ProcessingPath=ApplicationPath+'Processing/'
TargetPath=ApplicationPath+'Target_path/'
LogPath=ApplicationPath+'Logs/'
RunningFlag=ApplicationPath+'LSRMyMicros_ExtractionSchedule.txt'
...
# Email_TO_DL='"rasingh@starbucks.com"'
